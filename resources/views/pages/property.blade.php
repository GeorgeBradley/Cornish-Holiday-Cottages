...
<section class="m-t-3 container m-b-2" id="booking">
    ...
    <div class="social flex flex-jc-c flex-fw-w w-100">
        ...
        <form action="route{{ route('send_booking_mail') }}" method="POST" class="contact-form flex flex-jc-c flex-fd-c flex-fs-1 mw-100">
        ...
        <div class="flex flex-fd-c gap-1">
            ...
            <input type="text" name="property_name" value="{{$property->property_title   }}" class="p-1" readonly>
            @error('property_name')
                <div class="error-message-container">
                    <p class="error-message">{{ $message }}</p>
                </div>
